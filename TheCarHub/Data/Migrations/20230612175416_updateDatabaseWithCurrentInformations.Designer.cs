...
namespace TheCarHub.Data.Migrations
{
    ...
    [Migration("20230612175416_updateDatabaseWithCurrentInformations")]
    partial class updateDatabaseWithCurrentInformations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheCarHub.Areas.Admin.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheCarHub.Areas.Admin.Models.CarDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("RepairsCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TheCarHub.Areas.Admin.Models.CarDetails", b =>
                {
                    b.HasOne("TheCarHub.Areas.Admin.Models.Car", "Car")
                        .WithOne("CarDetails")
                        .HasForeignKey("TheCarHub.Areas.Admin.Models.CarDetails", "CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
